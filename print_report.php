...
$mpdf = new \Mpdf\Mpdf([
  'mode'          => 'utf-8',
  'format'        => 'A4',
  'margin_top'    => 50,  // enough to clear the header
  'margin_header' => 30,  // reserve 30mm for your patient block + barcode
  'margin_footer' => 30,
  'margin_left'   => 10,
  'margin_right'  => 10,
  'margin_bottom' => 40,
...
$headerHtml = '
<table width="100%" style="font-family:Arial,sans-serif;font-size:11pt;border:none">
  <tr>
...
<thead>
  ...
  <?php if (!empty($t['method'])): ?>
    <div style="font-weight:normal; font-size:9pt; margin-top:2px;">
